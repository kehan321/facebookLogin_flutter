...
import 'package:google_sign_in/google_sign_in.dart';
import 'package:provider/provider.dart';
import 'package:fbsocial/facebooksign.dart'; // Make sure to import Facebook sign-in provider
import 'package:fbsocial/applesignin.dart'; // Import Apple Sign-In if you're using it
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _signUpWithFirebase(String email, String password, String name) async {
    try {
      ...
      if (userCredential.user != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Sign up successful with Firebase!'),
          ),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Sign up failed with Firebase.'),
            backgroundColor: Colors.red,
          ),
        );
      }
  ...
  Future<void> _signOut() async {
    ...
    final facebookSignInController = Provider.of<FacebookSignInController>(context, listen: false);
  ...
  Future<void> _addUserDataToFirestore(String email, String name, [String? photoUrl]) async {
